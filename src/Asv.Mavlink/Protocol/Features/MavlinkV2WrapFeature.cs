...
{
    public static void RegisterMavlinkV2WrapFeature(this IProtocolFeatureBuilder builder,IProtocolMessageFactory<MavlinkMessage, int> factory)
    {
        builder.Register(new MavlinkV2WrapFeature(factory));
    }
}

public class MavlinkV2WrapFeature(IProtocolMessageFactory<MavlinkMessage, int> factory) : IProtocolFeature
{
    private readonly IProtocolMessageFactory<MavlinkMessage,int> _factory = factory;
