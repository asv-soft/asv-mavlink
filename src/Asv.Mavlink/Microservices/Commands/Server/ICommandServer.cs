...
public interface ICommandServer: IMavlinkMicroserviceServer
{
    ...
    /// This event stream allows subscribing to receive CommandLong packets.
    /// </remarks>
    /// <returns>
    ...
    /// </summary>
    /// <remarks>
    /// This property returns an <c>Observable&lt;CommandIntPacket&gt;</c>
    /// that can be subscribed to in order to receive CommandIntPacket events.
    /// </remarks>
...
public class CommandResult
{
    ...
    /// <summary>
    /// Returns a cached <see cref="CommandResult"/> instance corresponding to the given <see cref="MavResult"/> value.
    /// </summary>
    /// <param name="result">The MAVLink result code to convert.</param>
    /// <returns>A singleton <see cref="CommandResult"/> instance matching the given result code.</returns>
    ...
    /// <summary>
    /// Returns a cached <see cref="Task{CommandResult}"/> wrapping the <see cref="CommandResult"/> instance
    /// corresponding to the given <see cref="MavResult"/> value.
    /// </summary>
    /// <param name="result">The MAVLink result code to convert.</param>
    /// <returns>A singleton <see cref="Task{CommandResult}"/> matching the given result code.</returns>
    public static Task<CommandResult> AsTaskResult(MavResult result)
    {
        return result switch
        {
            ...
            _ => Task.FromResult(FromResult(result))
        };
    }
