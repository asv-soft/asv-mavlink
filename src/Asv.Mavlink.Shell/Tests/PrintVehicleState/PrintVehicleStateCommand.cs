...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    public async Task<int> Run(string connection, uint refreshRate = 3000)
    {
        try
        {
            ...
            using var sub = _keyListener.KeyPressed.SubscribeAwait(async (action, _) =>
            {
                await KeyPressedAsync(action, _cancel.Token);
            });
        ...
        switch (action)
        {
            ...
            case VehicleAction.PageUp:
                ...
                await _paramsClient.Write(
                    ...
                    Math.Clamp(valueUp.ParamValue + TelemetryParams.PageDelta, 100f, 3000f), 
                    cancel); 
                break;
            ...
            case VehicleAction.PageDown:
                ...
                await _paramsClient.Write(
                    TelemetryParams.VelocityMaxParamName, 
                    MavParamType.MavParamTypeReal32, 
                    Math.Clamp(valueDown.ParamValue - TelemetryParams.PageDelta, 100f, 3000f), 
                    cancel);
                break;
