...
public static class TelemetryParams
{
    ...
    public const int RedialDegLeft = 70;

    public const int RedialDegDown = 0;

    public const int RedialDegUp = 180;

    public const float TakeOffDelta = 50f;
    
    public const float PageDelta = 1.0f;
    
    public const string VelocityMaxParamName = "MPC_XY_VEL_MAX";
}
