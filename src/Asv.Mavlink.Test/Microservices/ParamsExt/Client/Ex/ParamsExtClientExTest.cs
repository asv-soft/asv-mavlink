...
public class ParamsExtClientExTest : ClientTestBase<ParamsExtClientEx>
{
    ...
    public void Constructor_NullArguments_Throws()
    {
        Assert.Throws<ArgumentNullException>(
            () => new ParamsExtClientEx(null!, _config, ParamsExtMeta.ClientParamsDescriptions));
        Assert.Throws<ArgumentNullException>(
            () => new ParamsExtClientEx(Client.Base, null!, ParamsExtMeta.ClientParamsDescriptions));
        Assert.Throws<ArgumentNullException>(
    ...
    {
        // Arrange
        var paramName = ParamsExtMeta.ClientParamsDescriptions.First().Name;
    ...
    public async Task WriteOnce_Timeout_Throws()
    {
        ...
        var paramValue = ParamsExtMeta.ServerParamsMeta.First().DefaultValue;
    ...
    protected override ParamsExtClientEx CreateClient(MavlinkClientIdentity identity, CoreServices core)
    {
        ...
        return new ParamsExtClientEx(client, _config, ParamsExtMeta.ClientParamsDescriptions);
    }
